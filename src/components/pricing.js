...
export default function pricing() {
  ...
  return (
    <div>
      ...
      <div className="csbgg" style={{ height: '60vh' }}>
        <div style={{ display: 'flex', maxWidth: '550px' }}>
          <div
            style={{
              display: 'flex',
          ...
          >
            <h1  style={{
             textAlign:'left'
            }}>Start Mining today!</h1>
            <p  style={{
             textAlign:'left'
            }}>
             Your state-of-the-art mining hardware is already running!
Just choose your favorite cryptocurrency or mining algorithm and get started in minutes!
            </p>
            <div
          style={{
            padding: '10px',
          ...
          <div class="row">
            <div class="col-12 col-sm-6 col-xl-4">
              <div class="feature">
                ...
                <p class="feature__text">
                  Minimum order price is 0.005 BTC for every
                  algorithm.
                </p>
              </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-xl-4">
              <div class="feature">
                ...
                <p class="feature__text">
                  Cancel at any time and get your remaining funds back
            ...
            <div class="col-12 col-sm-6 col-xl-4">
              <div class="feature">
                ...
                <p class="feature__text">
                  You decide how and when you want to buy hashing
                  power and which pool to direct it to.
                </p>
              </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-xl-4">
              <div class="feature">
                ...
                <p class="feature__text">
                  Never pay for dead, faulty configured rigs or
                  invalid shares.
                </p>
              </div>
            </div>
                ...
                <div class="col-12 col-lg-10 offset-lg-1 col-xl-12 offset-xl-0">
                  <div class="price">
                    ...
                    <ul class="price__list">
                      ...
                      <li>
                        <b>30 Months Bitcoin Mining:</b>{' '}
                      </li>
                      <li>
                        <b>SHA-256 Mining Algorithm</b>
                      </li>
                    ...
                    <div style={{ margin: '15px auto' }}>
                      <small>
                        highly rated by our user,perfect starting
                        options
                      </small>{' '}
                    </div>
                  </div>
                  ...
                  <div class="price">
                    ...
                    <div style={{ margin: '15px auto' }}>
                      <small>
                        highly rated by our users,faster mining
                        option,faster results
                      </small>{' '}
                    </div>
                  </div>
                  ...
                  <div class="price ">
                    ...
                    <div style={{ margin: '15px auto' }}>
                      <small>
                        highly rated by our users,huge earnings in a
                        short period
                      </small>{' '}
                    </div>
                  </div>
                  ...
                  <div class="price">
                    ...
                    <ul class="price__list">
                      <li>
                        <h3>
                          {`${Math.round(Number(input) / 28)}`}TH/s
                        </h3>{' '}
                      </li>
                      <li>
                        <b>30 Months Bitcoin Mining:</b>{' '}
                    ...
                    <div style={{ margin: '15px auto' }}>
                      <small>
                        highly rated by our verified users,recommended
                        for pro miners
                      </small>{' '}
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-12 col-lg-10 offset-lg-1 col-xl-12 offset-xl-0">
                  <div class="price">
                    ...
                    <div style={{ margin: '15px auto' }}>
                      <small>
                        highly rated by our users,perfect starting
                        options
                      </small>{' '}
                    </div>
                  </div>
                  ...
                  <div class="price">
                    ...
                    <div style={{ margin: '15px auto' }}>
                      <small>
                        highly rated by our users,our seasoned miners
                        love this plan
                      </small>{' '}
                    </div>
                  </div>
                  ...
                  <div class="price">
                    ...
                    <ul class="price__list">
                      <li>
                        <h3>
                          {`${Math.round(Number(input2) / 28)}`} TH/s
                        </h3>{' '}
                      </li>
                      <li>
                        <b>30 Months Ethereum Mining:</b>{' '}
      ...
      <Paper elevation={3}>
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ maxWidth: '800px', margin: '20px auto' }}>
            30 months of guaranteed runtime Your mining services will
            run for 30 months, period - even in cases where your daily
            mining reward falls below the Maintenance Fees. This way,
            you will always have the potential to produce
            cryptocurrencies as market conditions improve. The daily
            mining outputs are variable and are determined by these
            factors: the mining difficulty, the Bitcoin vs USD
            exchange rates, the Maintenance Fee (electricity, cooling,
            development, and servicing costs), and the technology used
            for mining. The first two factors are unpredictable and we
            can not control them, but we always deploy state of the
            art mining technology, and do our best to keep our data
            centers running at their maximum capability for you. You
            can find more in-depth information in our Customer Service
            Center
          </p>
        </div>
      </Paper>
      ...
      <p style={{ textAlign: 'center', margin: '20px 0' }}>
        ...
        hardware to having a contract with Epic-Mining
      </p>
      <Paper
        elevation={3}
        style={{
                  ...
                  <TableHead className={classes.head}>
                    <TableRow>
                      <TableCell className={classes.head}>
                        Costs of a contract with Epic-Mining
                      </TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    ...
                    <TableRow>
                      <TableCell component="th" scope="row">
                        We guarantee 100% uptime and cover system
                        downtimes by using our own miners{' '}
                        <div style={{ float: 'right' }}>
                          <DoneIcon className={classes.tick} />
                        </div>
                      </TableCell>
              ...
              <TableContainer component={Paper}>
                ...
                >
                  <TableHead className={classes.head}>
                    <TableRow>
                      <TableCell className={classes.head}>
                        Costs and externalities of having your own
                        hardware
                      </TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    ...
                    <TableRow>
                      <TableCell
                        ...
                        scope="row"
                      >
                        Waiting for delivery - you are losing
                        days,even weeks of mining time{' '}
                        <div style={{ float: 'left' }}>
                          <ClearIcon className={classes.cross} />
                        </div>
                      </TableCell>
                    ...
                    <TableRow>
                      <TableCell
                        ...
                        scope="row"
                      >
                        Electricity consumption of additional
                        equipment
                        <div style={{ float: 'left' }}>
                          <ClearIcon className={classes.cross} />
                        </div>
